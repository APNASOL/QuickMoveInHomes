...
Route::get('/all/communities/', [HomeController::class, 'all_communities'])->name('all.communities');
Route::get('/all/open/houses/', [HomeController::class, 'all_open_houses'])->name('all.open.houses');
