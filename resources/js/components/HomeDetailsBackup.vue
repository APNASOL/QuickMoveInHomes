    ...
    <Master>
        <div class="property-detail-section">
            <div class="property-detail-section" v-if="Home">
                    ...
                    <div class="info-overlay">
                        <div class="d-flex justify-content-between container">
                            ...
                            <div class="uppercase">
                                ...
                                <span v-if="Home.new_price_after_incentive" class="price ms-2 text-danger mt-3">
                                ...
                                <b v-if="Home.new_price_after_incentive">
                                    <br />
                                    after incentive</b>
                                <span class="price ms-2" v-if="Home.new_price_after_incentive">
                ...
                <div class="container-fluid interactive-open-house-banner mt-3"
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-8 mt-5">
                            <div class="details-section">
                                <div class="details d-flex justify-content-between text-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-8">
                            <div class="mt-2">
                                <!-- Main Carousel -->
                                <Carousel :wrapAround="true" :transition="500" id="gallery" :items-to-show="1"
                                    :wrap-around="false" v-model="currentSlide">
                                    <!-- Main Image Slides -->
                                    <Slide v-for="(file, index) in Home.files" :key="index">
                                        <img :src="file.file_name" :alt="file.file_original_name"
                                            class="img-fluid c-img-filter c-images-border-design" style="
                                                max-width: 100%;
                                                height: 400px;
                                                object-fit: cover;
                                            " @error="setAltImg" />
                                ...
                                <Carousel id="thumbnails" :items-to-show="4" :wrap-around="true" v-model="currentSlide"
                                    ...
                                    <!-- Thumbnail Images -->
                                    <Slide v-for="(file, index) in Home.files" :key="index">
                                        <div class="carousel__item" @click="slideTo(index)" style="cursor: pointer">
                                            <img :src="file.file_name" :alt="file.file_original_name" class="img-fluid"
                                                style="
                                                    max-height: 100px;
                                                    object-fit: cover;
                                                " />
                                ...
                                <div v-if="
                                    ...
                                    <div v-if="Home.incentive">
                                        <div class="banner-content">
                                            ...
                                            <div>
                                                <i class="bi bi-check-lg text-warning fs-5"></i>
                                                <a class="text-decoration-none c-anchor-style" :href="
                                                        '/detailed-incentive/' +
                                                        incentive.id
                                                    ">
                                                    {{ incentive.title }}</a>
                                    ...
                                    <div class="mt-2" v-if="Community">
                                        ...
                                        <i class="bi bi-check-lg text-warning fs-5"></i>
                                        {{ Community.name }}<br />
                                        <i class="bi bi-list text-warning fs-5"></i>
                                    ...
                                    <div class="highlights mt-2" v-if="Home.school_name">
                                        <div>
                                            ...
                                            <i class="bi bi-buildings-fill text-warning fs-5"></i>
                                            {{ Home.school_name }}
                                        </div>
                                    </div>
                                    <div class="highlights mt-2" v-if="Home.hoa_name">
                                        <div>
                                            ...
                                            <i class="bi bi-house text-warning fs-5"></i>
                                            {{ Home.hoa_name }}
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="middle-section row mt-2" v-if="
                            logged_in_user &&
                            logged_in_user.role === 'customer' &&
                            logged_in_user.agreement &&
                            user_home_visiting_history_count < 50
                    ...
                    <div class="accordion mt-2" id="accordionExample" v-if="
                            logged_in_user &&
                            logged_in_user.role === 'customer' &&
                            logged_in_user.agreement &&
                            user_home_visiting_history_count < 50
