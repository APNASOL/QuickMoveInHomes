            ...
            <ul class="sidebar-nav">
                ...
                <li class="nav-item" v-if="user_role == 'admin'">
                    ...
                    >
                        <li>
                            ...
                            >
                                <i
                                    class="bi bi-file-earmark-text me-2 text-success"
                                ></i>
                                Properties
                            </a>
                        </li>
                        <li>
                            <a
                                ...
                                href="/scraped-properties-upload"
                            >
                                <i class="bi bi-upload me-2 text-danger"></i>
                                Scraped Data Upload
                            </a>
                        </li>
                        <li>
                            ...
                            >
                                <i
                                    class="bi bi-person-check me-2 text-primary"
                                ></i>
                                Agents
                            </a>
                        </li>
                ...
                <li class="nav-item" v-if="user_role == 'admin'">
                    ...
                    >
                        ...
                        <li>
                            ...
                            >
                                <i
                                    class="bi bi-house-door me-2 text-danger"
                                ></i>
                                Neighborhood
                            </a>
                        </li>
                ...
                <li v-if="user_role == 'admin'">
                    <a
                        ...
                        href="/blogs/posts"
                    >
                        <i class="bi bi-journal me-2 text-primary"></i> Blog
                        Posts
                    </a>
                </li>
                <li v-if="user_role == 'admin'">
                ...
                <li class="nav-item" v-if="user_role == 'admin'">
                    ...
                    >
                        <li>
                            ...
                            >
                                <i
                                    class="bi bi-question-circle me-2 text-primary"
                                ></i>
                                Why Choose
                            </a>
                        </li>
                ...
                <li class="nav-item" v-if="user_role == 'admin'">
                    ...
                    >
                        <li>
                            ...
                            >
                                <i
                                    class="bi bi-envelope-arrow-up-fill me-2 text-info"
                                ></i>
                                Welcome Email
                            </a>
                        </li>
                        <li>
                            ...
                            >
                                <i
                                    class="bi bi-envelope-arrow-up-fill me-2 text-warning"
                                ></i>
