  ...
  <div>
    ...
    >
      ...
      >
        ...
        <button class="btn border-0 pe-0" type="button" @click="toggleSidebar">
          ...
          >
            <li>
              <a
                ...
                href="/properties"
                ><i class="bi bi-file-earmark-text me-2"></i> Properties</a
              >
            </li>
            <li>
              <a
                class="nav-link"
                :class="{ active: isActive('/scraped-properties-upload') }"
                href="/scraped-properties-upload"
                ><i class="bi bi-upload me-2"></i> Scraped Data Upload</a
              >
            </li>
            <li>
              <a
                ...
                href="/agents"
                ><i class="bi bi-person-check me-2"></i> Agents</a
              >
            </li>
            <li>
              <a
                ...
                href="/homes"
                ><i class="bi bi-house-door me-2"></i> Quick Move In</a
              >
            </li>
          </ul>
        </li>
          ...
          >
            ...
            <li>
              <a
                class="nav-link"
                :class="{
                  active: isActive('/scraped-communities-upload'),
                }"
          ...
          >
            ...
            <li>
              <a
                ...
                href="/neighborhoods"
                ><i class="bi bi-house-door me-2"></i> Neighborhood</a
              >
            </li>
          </ul>
        </li>
          ...
          >
            <li>
              <a
                ...
                href="/our-promises"
                ><i class="bi bi-question-circle me-2"></i> Why Choose</a
              >
            </li>
            <li>
              <a
                ...
                ><i class="bi bi-person me-2"></i> User Contact</a
              >
            </li>
            <li>
              <a
          ...
          >
            <li>
              <a
                ...
                href="/welcome-email"
                ><i class="bi bi-envelope-arrow-up-fill me-2"></i> Welcome
                Email</a
              >
            </li>
            <li>
              <a
                ...
                ><i class="bi bi-envelope-arrow-up-fill me-2"></i> Reset
                Password Email</a
              >
            </li>
          </ul>
...
export default {
  ...
  mounted() {
    ...
    const dropdowns = {
      "properties-nav": ["/properties", "/scraped-properties-upload", "/agents", "/homes"],
      "communities-nav": ["/scraped-communities-upload","/communities", "/builders"],
    ...
    for (const key in dropdowns) {
      if (
        dropdowns[key].some((route) => window.location.pathname.includes(route))
      ) {
