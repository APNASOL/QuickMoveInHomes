<template>
    <Master>
        <div class="d-flex justify-content-between align-items-center">
            <div class="pagetitle">
                <h1 class="mb-0">
                    <span v-if="process_status == 'edit'">Edit Activity</span>
...
export default {
    props: ["tour_id", "process_status", "activity_id"],
    components: {
        Master,
        ImageCropper,
        Multiselect,
    ...
    methods: {
        async getActivity() {
            await axios
                .get("/api/get-activity-edit/" + this.activity_id)
                .then((response) => {
        ...
        async submit() {
            ...
            await axios
                .post("/api/activity-save", this.form)
                .then((response) => {
                    this.formStatus = true;

                    toastr.success(this.translate("Activity saved successfully"));
