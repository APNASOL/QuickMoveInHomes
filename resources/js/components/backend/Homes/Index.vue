...
export default {
    ...
    methods: {
            ...
            axios
                ...
                .then((response) => {
                    if (this.firstTimeLoadCheck === 1) {
                        this.QuickMoveHomes = response.data.data;
                        this.firstTimeLoadCheck = 0;
                    } else {
                        this.QuickMoveHomes = this.QuickMoveHomes.concat(
                            response.data.data
                        );
                    }
                    this.formStatus = 1;
        ...
        deleteThis(id) {
            axios
                .post("/api/home/delete/" + id)
                .then((response) => {
                    toastr.success(
                        this.translate("Home deleted successfully.")
                    );
                    setTimeout(() => {
