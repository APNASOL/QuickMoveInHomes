<template>
    ...
    <!-- delete Modal -->
    <div class="modal fade" :id="'deleteModal-' + randId" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h2>
                        {{ translate("Crop and Upload") }}
                    </h2>
                </div>
                        ...
                        <section class="cropper-area">
                            <div class="img-cropper row">
                                <div class="col-md-8">
                                    <vue-cropper
                                        ref="cropper" 
                                        :aspect-ratio="ratio ?? defaultAspectedRatio"
                                        :src="imgSrc"
                                        preview=".preview"
                                    />
                                </div>
                            ...
                            <div class="actions">
                                <a
                                    href="#"
                                    class="btn btn-sm btn-outline-success btn-zoom-in"
                                    role="button"
                                ...
                                <a
                                    href="#"
                                    class="btn btn-sm btn-outline-success btn-zoom-out"
                                    role="button"
                                    @click.prevent="zoom(-0.2)"
                                >
                                ...
                                <!-- <a href="#" class="btn btn-sm btn-info" ="button" @click.prevent="getData">
                                    Get Data
                                </a> -->
    ...
    methods: {
        ...
        setImage(e) {
            ...
            if (file.type.indexOf("image/") === -1) {
                toastr.error(this.translate("Please select an image file"));
                return;
            }
            ...
            if (typeof FileReader === "function") {
                ...
                toastr.error(this.translate("Sorry, FileReader API not supported"));
            }
        },
        showFileChooser() {
